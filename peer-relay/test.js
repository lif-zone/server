...
describe('channels', ()=>{
  ...
  it('get_closest2', ()=>{
    ...
    _t('10 15 20', 9, {}, 20);
    _t('10 20 25 30 40 50', 26, {}, 25);
    _t('10 20 25 30 40 50', 24, {}, 20);
    _t('10 20 25 30 40 50', 25, {}, 25);
    _t('10 20 25 30 40 50', 25, {bigger: true}, 25);
    _t('10 20 25 30 40 50', 25, {skip_self: true}, 20);
    _t('10 20 25 30 40 50', 25, {skip_self: true, bigger: true}, 30);
    _t('10 20 25 30 40 50', 50, {}, 50);
    _t('10 20 25 30 40 50', 50, {bigger: true}, 50);
    _t('10 20 25 30 40 50', 50, {skip_self: true}, 40);
    _t('10 20 25 30 40 50', 50, {skip_self: true, bigger: true}, 10);
    let t = (nodes, val, exp)=>_t(nodes, val, {bigger: true}, exp);
    t('10 20 25 30 40 50', 9, 10);
    t('10 20 25 30 40 50', 10, 10);
    t('10 20 25 30 40 50', 11, 20);
    t('10 20 25 30 40 50', 24, 25);

...
const cmd_req = opt=>etask(function*req(){
  ...
  if (t_pre_process){
    set_orig(c, build_cmd_o(c.meta.cmd, {id, cmd, seq, ack, body,
      res, '!e': !call ? undefined : true, emit_api, ooo, dup, close}));
    if (e){
...
describe('peer-relay', function(){
  ...
  describe('test_api', function(){
    describe('pre_process', function(){
      ...
      describe('shortcut', ()=>{
        ...
        if (0) // XXX NOW: TODO
        _t('mode(msg req)',
          'ac>!req(id:r1 cmd:test seq:1 ack:2 body:ping res:ping_r)', `
          ...
          bc<fwd(msg(id(r1) type(res) cmd(test) body(ping_r)))
  ...
  describe('req_new', function(){
    ...
    describe('3_nodes', ()=>{
      ...
      t('req', `
        ...
        ac>!req(id:r0 body:ping res:ping_r !e) ac>*req(id:r0 body:ping)
      ...
      t('msg', `
        ...
        ac>!req(id:r0 body:ping res:ping_r !e)
  ...
  describe('3_nodes', function(){
    ...
    describe('linear_simple', ()=>{
      ...
      // XXX NOW: rm !e after support abc>!req
